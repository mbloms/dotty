...
// ----- Desugar methods -------------------------------------------------
  ...
  def classDef(cdef: TypeDef)(implicit ctx: Context): Tree = {
    ...
    val phantomTrait: TypeDef = {
      ...
      TypeDef(name.toTypeName,Template(emptyConstructor,List(Ident(className)),makeSelfDef(name.toTermName,EmptyTypeIdent),Nil)).withMods(Modifiers(Synthetic | Trait))
    }
