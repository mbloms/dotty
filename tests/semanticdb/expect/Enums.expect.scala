object Enums/*<-_empty_::Enums.*/ where
  import <:</*->_empty_::Enums.`<:<`.*/._

  enum Colour/*<-_empty_::Enums.Colour#*/ where
  ...
  enum Directions/*<-_empty_::Enums.Directions#*/ where
  ...
  enum Suits/*<-_empty_::Enums.Suits#*/ derives /*->scala::CanEqual.derived.*/CanEqual where
  ...
  object Suits/*<-_empty_::Enums.Suits.*/ where
  ...
  enum WeekDays/*<-_empty_::Enums.WeekDays#*/ where
  ...
  enum Coin/*<-_empty_::Enums.Coin#*/(value/*<-_empty_::Enums.Coin#value.*/: Int/*->scala::Int#*/) where
  ...
  enum Maybe/*<-_empty_::Enums.Maybe#*/[+A/*<-_empty_::Enums.Maybe#[A]*/] where
  ...
  enum Tag/*<-_empty_::Enums.Tag#*/[A/*<-_empty_::Enums.Tag#[A]*/] where
  ...
  enum Planet/*<-_empty_::Enums.Planet#*/(mass/*<-_empty_::Enums.Planet#mass.*/: Double/*->scala::Double#*/, radius/*<-_empty_::Enums.Planet#radius.*/: Double/*->scala::Double#*/) extends Enum/*->java::lang::Enum#*/[Planet/*->_empty_::Enums.Planet#*/]/*->java::lang::Enum#`<init>`().*/ where
